    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Statusess", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsobaOdpowiedzialnaId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CurentStatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Zdarzenia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Zdarzenia_AspNetUsers_OsobaOdpowiedzialnaId",
                        column: x => x.OsobaOdpowiedzialnaId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Zdarzenia_OsobaOdpowiedzialnaId",
                table: "Zdarzenia",
                column: "OsobaOdpowiedzialnaId");
        }

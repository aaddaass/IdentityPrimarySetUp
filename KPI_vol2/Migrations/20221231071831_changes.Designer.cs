...
namespace KPI_vol2.Migrations
{
    ...
    [Migration("20221231071831_changes")]
            ...
            modelBuilder.Entity("KPI_vol2.Models.Device", b =>
                {
                    ...
                    b.Property<int?>("UzytkownikDeviceDeviceID")
                        .HasColumnType("int");

                    b.Property<int?>("UzytkownikDeviceUzytkownikID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UzytkownikDeviceDeviceID", "UzytkownikDeviceUzytkownikID");
            ...
            modelBuilder.Entity("KPI_vol2.Models.Device", b =>
                {
                    ...
                    b.HasOne("KPI_vol2.Models.Uzytkownik", null)
                        .WithMany("devices")
                        .HasForeignKey("UzytkownikId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("KPI_vol2.Models.UzytkownikDevice", null)
                        .WithMany("Devices")
                        .HasForeignKey("UzytkownikDeviceDeviceID", "UzytkownikDeviceUzytkownikID");
